import { View, Platform, SafeAreaView, StatusBar, Text, StyleSheet, TouchableOpacity, ScrollView } from 'react-native'
    ...
    <Dialog visible={openDialog} onDismiss={hideDialog}>
        ...
        <Dialog.Content>
            ...
            <View style={{flexDirection: "row", alignItems: "center"}}>
                ...
                <Button color="#900" onPress={addTaskHandler} disabled={!title || !description || loading}>
                    ADD
                </Button>
            </View>
        </Dialog.Content>
...
const styles = StyleSheet.create({
    heading: {
        fontSize: 28, textAlign: "center", marginTop: 25, marginBottom: 20, color: "#fff", backgroundColor: "#474747"
    },
    addBtn: {
        backgroundColor: "#fff",
        width: 150,
