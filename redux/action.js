...
const serverUrl = "https://native-todo-app-server-ae5c28734b69.herokuapp.com/api/v1"
...
export const login = (email, password) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.post(`${serverUrl}/login`, {email,password}, {headers: {"Content-Type": "application/json"}})
...
export const addTask = (title, description) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.post(`${serverUrl}/newtask`,{title, description}, {headers: {
...
export const updateProfile = (formData) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.put(`${serverUrl}/updateprofile`,formData,{headers: {"Content-Type": "multipart/form-data"}})
...
export const register = (formData) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.post(`${serverUrl}/register`,formData,{headers: {"Content-Type": "multipart/form-data"}})
...
export const updatePassword = (oldPassword, newPassword) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.put(`${serverUrl}/updatepassword`,{oldPassword, newPassword},{headers: {"Content-Type": "application/json"}})
...
export const verify = (otp) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.post(`${serverUrl}/verify`,{otp},{headers: {"Content-Type": "application/json"}})

        dispatch({type: "verificationSuccess", payload: data.message})
        
    } catch (error) {
        dispatch({type: "verificationFailure", payload: error.response.data.message})
    }
}
...
export const forgetPassword = (email) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.post(`${serverUrl}/forgetpassword`,{email},{headers: {"Content-Type": "application/json"}})
...
export const resetPassword = (otp, newPassword) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.put(`${serverUrl}/resetpassword`,{otp, newPassword},{headers: {"Content-Type": "application/json"}})
